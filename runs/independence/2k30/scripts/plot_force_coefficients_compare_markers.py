...
# Load solution obtained on nominal grid.
label = 'Nominal'
...
# Load solution obtained on nominal grid with slightly displaced markers.
label = 'Displaced markers'
simudir = maindir / 'markers'
solution = get_force_coefficients(simudir)
mean = get_time_averaged_stats(solution, (50.0, 80.0))
solutions[label], means[label] = solution, mean
...
ax.annotate('$C_D$', xy=(40.0, 0.70), xytext=(30.0, 0.25),
            arrowprops=dict(facecolor='black', arrowstyle='-|>',
                            shrinkA=0, shrinkB=0))
ax.annotate('$C_L$', xy=(40.0, 2.30), xytext=(30.0, 2.75),
            arrowprops=dict(facecolor='black', arrowstyle='-|>',
                            shrinkA=0, shrinkB=0))
fig.tight_layout()
...
if save_figure:
    ...
    filepath = figdir / 'force_coefficients_compare_markers.png'
